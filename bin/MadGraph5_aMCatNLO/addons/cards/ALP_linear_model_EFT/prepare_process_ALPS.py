...
if os.path.isfile(working_dir+"/"+str(tag)+"_proc_card.dat"):
	print("WARNING, %s/proc_card.dat already exists! OVERWRITING!!!!"%working_dir)
proc_card_ = open(working_dir+"/"+str(tag)+"_proc_card.dat","w")
...
print("--> wrote to %s/%s_proc_card.dat"%(working_dir,tag))
...
if os.path.isfile(working_dir+"/"+str(tag)+"_customizecards.dat"):
	print("WARNING, %s/customizecards.dat already exists! OVERWRITING!!!!"%working_dir)
customizecards_ = open(working_dir+"/"+str(tag)+"_customizecards.dat","w")
...
customizecards_.write("set param_card mass 9000005 100 \n")
customizecards_.write("set param_card width 9000005 10 \n")
...
print("--> wrote to %s/%s_customizecards.dat"%(working_dir,tag))
...
if os.path.isfile(working_dir+"/"+str(tag)+"_run_card.dat"):
...
print("--> wrote to %s/%s_run_card.dat"%(working_dir,tag))
...
reweight_card_ = open(working_dir+"/"+str(tag)+"_reweight_card.dat","w")
...
print("--> wrote to %s/%s_reweight_card.dat"%(working_dir,tag))
